...
\begin{frame}{}
  \begin{columns}
    ...
    \begin{column}{.5\textwidth}
      \begin{onlyenv}<1-3>
        \begin{center}
          \includegraphics<1>[width=0.5\textwidth]{resources/placeholder1}%
          \includegraphics<2>[width=0.5\textwidth]{resources/placeholder2}%
          \includegraphics<3>[width=0.5\textwidth]{resources/placeholder3}%
        \end{center}
      \end{onlyenv}
    \end{column}
  \end{columns}
